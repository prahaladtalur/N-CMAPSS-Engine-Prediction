...
from src.models import star_transformer  # noqa: F401
...
def get_model_info() -> dict[str, str]:
    ...
    return {
        ...
        "mdfa_paper": "MDFA paper-style head without the legacy BiLSTM wrapper",
        ...
        "star_transformer": "STAR Transformer — two-stage sensor-wise then temporal attention (Sensors 2024)",
